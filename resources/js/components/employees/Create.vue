                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            Add New Employee
                            <router-link :to="{name :'EmployeesIndex'}" class="btn btn-danger float-right">Back</router-link>
                        </div>
                            <form class="py-4" @submit.prevent="storeEmployee">

                                <div class="row mb-3 justify-content-between px-4">
                                    <label for="first_name" class="col-md-4 col-form-label text-md-end">First Name</label>

                                    <div class="col-md-6">
                                        <input id="first_name" type="text" class="form-control" required autofocus v-model="form.first_name">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 justify-content-between px-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" aria-label="Default select example" v-model="form.country_id" @change="getStates()">
                                ...
                                <div class="row mb-3 justify-content-between px-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" aria-label="Default select example" v-model="form.state_id" @change="getCities()">
                                ...
                                <div class="row mb-3 justify-content-between px-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" aria-label="Default select example" v-model="form.department_id">
                                ...
                                <div class="row mb-3 justify-content-between px-4">
                                    <label for="city" class="col-md-4 col-form-label text-md-end">Birth Date</label>

                                    <div class="col-md-6">
                                            <datepicker class="e-calendar" v-model="form.birth_date" />
                                    </div>
                                </div>

                                <div class="row mb-3 justify-content-between px-4">
                                    <label for="city" class="col-md-4 col-form-label text-md-end">Hired At</label>

                                    <div class="col-md-6 wrap">
                                        <datepicker class="e-calendar" v-model="form.hired_date" />
                                    </div>
                                </div>
