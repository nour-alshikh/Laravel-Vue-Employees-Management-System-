...
@section('content')
    <div class="d-flex justify-content-between align-items-center w-100 px-4">
        <h1>Countries</h1>
        <h3>Update Country - {{ $country->name }}</h3>
    </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form method="POST" class="py-4" action="{{ route('countries.update' , $country->id) }}">
                                @csrf
                                @method('PUT')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to delete {{ $country->name }} ?</h5>
                ...
                <div class="modal-footer">
                    ...
                    <form id="delete-form" action="{{ route('countries.destroy' ,$country->id) }}" method="POST" class="d-none">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
